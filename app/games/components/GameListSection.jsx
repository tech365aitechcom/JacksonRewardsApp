...
export const GameListSection = ({ searchQuery = "", showSearch = false }) => {
  ...
  const downloadedGames = allDownloadedGames.map((game) => {
    ...
    // Coins: prefer backend totalCoins, then sum of completed goals' coinReward (fallback to amount/points)
    ...
    // XP: total potential XP from ALL goals (not just completed) — matches totalCoins behavior
