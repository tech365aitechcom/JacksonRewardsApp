...
function BlockedContent() {
  ...
  const getIcon = () => {
    ...
    if (reason === "proxy_detected") return "🔐";
  ...
  const getTitle = () => {
    if (reason === "vpn_detected") return "VPN Active";
    if (reason === "proxy_detected") return "Proxy Active";
    if (reason === "tor_detected") return "Tor Network Active";
