                ...
                <div className="flex items-center justify-between w-full">
                    <div className="flex items-center gap-4">
                        <Image
                            ...
                            height={24}
                            alt="Notifications"
                            src="/assets/animaapp/V1uc3arn/img/line-media-notification-3-line.svg"
                            className="w-6 h-6"
                            loading="eager"
                            decoding="async"
                            priority
                ...
                <div className="flex items-center justify-between w-full mt-6">
                    <div className="flex items-center gap-4">
                        <Image
                            ...
                            height={24}
                            alt="Language"
                            src="/assets/animaapp/V1uc3arn/img/line-editor-translate-2.svg"
                            className="w-6 h-6"
                            loading="eager"
                            decoding="async"
                            priority
                ...
                <div className="flex items-center justify-between w-full">
                    <div className="flex items-center gap-4">
                        <Image
                            ...
                            height={24}
                            alt="Security"
                            src="/assets/animaapp/V1uc3arn/img/line-business-projector-2-line.svg"
                            className="w-6 h-6"
                            loading="eager"
                            decoding="async"
                            priority
                ...
                <div className="flex items-center justify-between w-full mt-6">
                    <div className="flex items-center gap-4">
                        <Image
                            ...
                            height={24}
                            alt="Theme"
                            src="/assets/animaapp/V1uc3arn/img/line-health-mental-health-line.svg"
                            className="w-6 h-6"
                            loading="eager"
                            decoding="async"
                            priority
                ...
                <div className="flex items-center justify-between w-full">
                    <div className="flex items-center gap-4">
                        <Image
                            ...
                            src="/assets/animaapp/V1uc3arn/img/line-user-contacts-line.svg"
                            className="w-6 h-6"
                            loading="eager"
                            decoding="async"
                            priority
                    ...
                    >
                        <Image
                            ...
                            height={24}
                            alt="Arrow"
                            src="/assets/animaapp/V1uc3arn/img/arrow-back-ios-new-3-2x.png"
                            className="w-6 h-6"
                            loading="eager"
                            decoding="async"
                            priority
                ...
                {/* <div className="flex items-center justify-between w-full mt-6">
                    <div className="flex items-center gap-4">
                        <Image
                            ...
                            height={24}
                            alt="Contact us"
                            src="/assets/animaapp/V1uc3arn/img/line-communication-chat-quote-line.svg"
                            className="w-6 h-6"
                            loading="eager"
                            decoding="async"
                            priority
                ...
                <div className="flex items-center justify-between w-full mt-6">
                    <div className="flex items-center gap-4">
                        <Image
                            ...
                            height={24}
                            alt="Privacy policy"
                            src="/assets/animaapp/V1uc3arn/img/line-system-lock-2-line.svg"
                            className="w-6 h-6"
                            loading="eager"
                            decoding="async"
                            priority
