...
export async function isGooglePlayAvailable() {
  try {
    ...
    console.warn("[GooglePlayBilling] isBillingSupported check failed");
    return false
  }
}
...
export async function getSubscriptionProduct(productInfo) {
  try {
    ...
    console.error("[GooglePlayBilling] getSubscriptionProduct error");
    throw err
  }
}
...
export async function restorePurchases() {
  try {
    ...
    console.error("[GooglePlayBilling] restorePurchases error");
    throw err
  }
}
