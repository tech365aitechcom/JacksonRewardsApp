...
const initialState = {
  ...
  // Image caching for performance (serializable)
...
const gameSlice = createSlice({
  ...
  reducers: {
    ...
    clearGames: (state) => {
      ...
      // Clear image cache when clearing games
      state.imageCache = {};
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchUserData.pending, (state, action) => {
        ...
        // Background refreshes do NOT set loading status
      ...
      .addCase(fetchUserData.fulfilled, (state, action) => {
        ...
        // Background refreshes do NOT update status
      ...
      .addCase(fetchBitlabsDownloadedGames.fulfilled, (state, action) => {
        ...
        const mappedGames = bitlabsGames.map((game) => {
          ...
          // Use total_approved_points from API for total coins (this is the correct earned amount)
        ...
        // If the user is currently on the Details Page for a Bitlabs game,
