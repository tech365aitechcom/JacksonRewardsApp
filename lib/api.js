...
const apiRequest = async (
  ...
  // Google Play Integrity token for high/medium security endpoints (backend may require X-Integrity-Token)
  if (options.integrityToken) {
    headers["X-Integrity-Token"] = options.integrityToken;
  }
