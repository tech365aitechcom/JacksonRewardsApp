...
class AppLovinMAXPlugin {
  ...
  async initialize(config = {}) {
    ...
    const admobAppId = platform === 'ios' ? APPLOVIN_CONFIG.GOOGLE_ADMOB_APP_ID.IOS : APPLOVIN_CONFIG.GOOGLE_ADMOB_APP_ID.ANDROID;
    console.log('[AdMob/UMP] Google AdMob App ID (mob id) for', platform, ':', admobAppId);
